#!/usr/bin/env python3
"""
Generate visualizations for modality investigation:
What paper representations are optimal for SFT Finetuning?

Compares three variants:
- Full Paper: Clean text only
- Full Paper w/ Figures: Text + embedded figures
- Full Paper as Images: Paper rendered as images
"""
...
VARIANTS = {
    "Full Paper": {
        ...
        "train_data": "data/iclr_2020_2025_85_5_10_split6_balanced_clean_binary_noreviews_v6_train/data.json",
        "train_log": "saves/data_sweep_v2/iclr20_balanced_clean/trainer_state.json",
    },
    "Full Paper w/ Figures": {
        ...
        "train_data": "data/iclr_2020_2025_85_5_10_split6_balanced_clean_images_binary_noreviews_v6_train/data.json",
        "train_log": "saves/data_sweep_clean_images/balanced_clean_images/trainer_state.json",
    },
    "Full Paper as Images": {
        ...
        "train_data": "data/iclr_2020_2025_85_5_10_split6_balanced_vision_binary_noreviews_v6_train/data.json",
        "train_log": "saves/data_sweep_v2/iclr20_balanced_vision/trainer_state.json",
    },
}
...
# Colors for variants
COLORS = {
    "Full Paper": "#1f77b4",       # Blue
    "Full Paper w/ Figures": "#ff7f0e",  # Orange
    "Full Paper as Images": "#2ca02c",   # Green
}
...
def plot_data_table(all_metrics: dict, output_dir: Path):
    ...
    plt.title('Modality Investigation: Metrics Comparison', fontsize=14, fontweight='bold', pad=20)
    plt.tight_layout()
...
def plot_recall_bars(all_metrics: dict, output_dir: Path):
    ...
    ax.set_title('Accept/Reject Recall by Modality', fontsize=14, fontweight='bold')
    ax.set_xticks(x)
