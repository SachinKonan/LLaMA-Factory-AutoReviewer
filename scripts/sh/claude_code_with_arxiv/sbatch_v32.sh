#!/bin/bash
#SBATCH --job-name=cc-arxiv-v32
#SBATCH --partition=all
#SBATCH --time=02:00:00
#SBATCH --mem=16G
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/claude_code_with_arxiv/sbatch_v32_%j.out
#SBATCH --error=logs/claude_code_with_arxiv/sbatch_v32_%j.err

# Claude Code v3.2 with arxiv search via MCP.
#
# Usage:
#   sbatch scripts/sh/claude_code_with_arxiv/sbatch_v32.sh coding_agents_2026_claudecode_v3.2a
#   sbatch scripts/sh/claude_code_with_arxiv/sbatch_v32.sh coding_agents_2026_claudecode_v3.2b
...
AGENT_DIR_NAME="${1:?Usage: sbatch sbatch_v32.sh <AGENT_DIR_NAME>}"
...
# ============================================
# Build orchestrator prompt (auto-detect with-model vs no-model from CSV header)
# ============================================
