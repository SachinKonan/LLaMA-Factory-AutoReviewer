#!/bin/bash
# Informed text review — Qwen3.5-122B-A10B — ailab partition (shards 0-14)
# Usage: sbatch scripts/sh/gemini_synthetic_reasoning/qwen3.5/informed/ailab.sh

#SBATCH --job-name=qwen-informed-ailab
#SBATCH --array=0-14
...
echo "=== Qwen Informed Text Review (ailab) ==="
