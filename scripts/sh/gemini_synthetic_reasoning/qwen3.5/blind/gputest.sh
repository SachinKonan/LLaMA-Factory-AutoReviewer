#!/bin/bash
# Blind text review — Qwen3.5-122B-A10B — gpu-test partition (shards 0-18)
# Usage: sbatch scripts/sh/gemini_synthetic_reasoning/qwen3.5/blind/gputest.sh

#SBATCH --job-name=qwen-blind-gputest
#SBATCH --array=0-18
...
echo "=== Qwen Blind Text Review (gpu-test) ==="
