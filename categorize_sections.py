...
with open("/scratch/gpfs/ZHUANGL/jl0796/LLaMA-Factory-AutoReviewer/outputs/best_2025_2026_vision_v-1/filtered_section_counts.json", "r") as f:
...
with open("/scratch/gpfs/ZHUANGL/jl0796/LLaMA-Factory-AutoReviewer/outputs/best_2025_2026_vision_v-1/categorized_sections.json", "w") as f:
    json.dump({
        "summary_counts": dict(category_counts),
        "detailed_mapping": dict(categorized_sections)
    }, f, indent=2)

print("\nSaved to categorized_sections.json")
